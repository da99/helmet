...
This can mitigate cross-site scripting (XSS) vulnerabilities, clickjacking, formjacking, malicious frames,
unwanted trackers, and other web client-side attacks.

  If you want to learn how CSP works, check out the fantastic:
   * HTML5 Rocks guide: https://www.html5rocks.com/en/tutorials/security/content-security-policy/
   * Content Security Policy Reference: https://content-security-policy.com/
   * and the Content Security Policy specification: https://www.w3.org/TR/CSP/
